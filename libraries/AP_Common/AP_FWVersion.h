...
public:
    ...
    const uint8_t middle_major; // Align version
    const uint8_t middle_minor; // Align version
    const uint8_t middle_patch; // Align version
    const uint8_t middle_type; // Align version type
